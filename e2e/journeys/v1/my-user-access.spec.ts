/**
 * V1 My User Access - All Personas
 *
...
import { AUTH_V1_ADMIN, AUTH_V1_USER, AUTH_V1_USERADMIN, AUTH_V1_USERVIEWER, setupPage } from '../../utils';

const personas = [
  { name: 'OrgAdmin', auth: AUTH_V1_ADMIN },
  { name: 'UserAdmin', auth: AUTH_V1_USERADMIN },
  { name: 'UserViewer', auth: AUTH_V1_USERVIEWER },
  { name: 'ReadOnlyUser', auth: AUTH_V1_USER },
];

for (const { name, auth } of personas) {
  test.describe(`V1 My User Access - ${name}`, () => {
