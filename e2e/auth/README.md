...
|------|-------------|-------|
| `.env.v1-orgadmin` | Credentials for V1 OrgAdmin | Loaded by `e2e:v1:auth:orgadmin` |
...
| `.env.v2-orgadmin` | Credentials for V2 OrgAdmin | Loaded by `e2e:v2:auth:orgadmin` |
...
| `v1-orgadmin.json` | Playwright session state | Generated by auth step |
...
```bash
# Example: e2e/auth/.env.v1-orgadmin
...
|---------|----------|------------------|-------|
| OrgAdmin | Org Admin | Full access | Can do everything |
