...
* add sast tasks ([#1787](https://github.com/riccardo-forina/insights-rbac-ui/issues/1787)) ([9442e25](https://github.com/riccardo-forina/insights-rbac-ui/commit/9442e2568bbd2536885bfbc4e71a7c9cb772a3ab))
* **addGroup:** incorporate pf6 to branch ([3c1436a](https://github.com/riccardo-forina/insights-rbac-ui/commit/3c1436a48f1750170a2a2065c595be5b18e30105))
* **AddGroupMembers:** restored filtering capabilities ([0ba659a](https://github.com/riccardo-forina/insights-rbac-ui/commit/0ba659a6a5c8f7f3120cdc13716340bb62da6987))
* **AddGroupWizard:** ensure service accounts are properly added ([6393cd6](https://github.com/riccardo-forina/insights-rbac-ui/commit/6393cd650b7a03eba4aaa2f34962e5ac224b9ff2))
* **AddGroupWizard:** fix lint ([61fd6e3](https://github.com/riccardo-forina/insights-rbac-ui/commit/61fd6e3b75a19ab82168bbece5e5b436df12c0aa))
* address CodeRabbit review feedback ([6c81602](https://github.com/riccardo-forina/insights-rbac-ui/commit/6c81602a47129f6975ba3fa7090eba9359129c3b))
* address console.warns ([c6d342d](https://github.com/riccardo-forina/insights-rbac-ui/commit/c6d342d3ab2cc9a328294964b68bfcc479853755))
* address remaining CodeRabbit review findings ([ad74c06](https://github.com/riccardo-forina/insights-rbac-ui/commit/ad74c06477f99b136e5dea44be502cbbc13d7469))
* address skipped Storybook tests ([8d84829](https://github.com/riccardo-forina/insights-rbac-ui/commit/8d848294883b95a8fb9324c0524a84496391e4b6))
* **admin-group:** when we don't have admin group do not break ([#1765](https://github.com/riccardo-forina/insights-rbac-ui/issues/1765)) ([881e1da](https://github.com/riccardo-forina/insights-rbac-ui/commit/881e1dad988d8e624a7eb4f245ffa1e2b1a5cd66))
* allow users to see the full list of permissions for their own profile ([#1858](https://github.com/riccardo-forina/insights-rbac-ui/issues/1858)) ([0d0d4de](https://github.com/riccardo-forina/insights-rbac-ui/commit/0d0d4de06a05e54e5cca1b6597b176b9ff669bd1))
* **api-arg:** js clients has broken arguments so we have to use list of args ([#1844](https://github.com/riccardo-forina/insights-rbac-ui/issues/1844)) ([e3f2d4a](https://github.com/riccardo-forina/insights-rbac-ui/commit/e3f2d4a02b78c869bd1dab30048f9f4e4402881d))
* attempt at fixing issue with user access roles not seeing what they should in rbac UI ([f1c44d1](https://github.com/riccardo-forina/insights-rbac-ui/commit/f1c44d1ae82713ba11f4dc485f5de15101f1e540))
* **Axios:** update request to use correct params ([ba338ba](https://github.com/riccardo-forina/insights-rbac-ui/commit/ba338ba59cd8fa194f7dd17ae2073b6cb2a17d21))
* **basename:** basename for workspaces is calculated incorrectly ([#1699](https://github.com/riccardo-forina/insights-rbac-ui/issues/1699)) ([113a38e](https://github.com/riccardo-forina/insights-rbac-ui/commit/113a38e4d3475e79252a0e931c203056d6e77359))
* **bug:** fix circular structure error in user activation toggle ([3b3f983](https://github.com/riccardo-forina/insights-rbac-ui/commit/3b3f9836f2898fe8be6e3ad7d5dcb2a33bf065aa))
* changes to role table filtering to prevent strange behavior ([48febbf](https://github.com/riccardo-forina/insights-rbac-ui/commit/48febbf8eb6cbe242dd30be9008ee85bec2373ba))
* chromatic workflow ([d4e1b8b](https://github.com/riccardo-forina/insights-rbac-ui/commit/d4e1b8b5c3a0e4f56ec6cbf7b655fa6e3fb6b923))
* **ci:** skip Chromatic upload when Storybook build fails ([eb2cb78](https://github.com/riccardo-forina/insights-rbac-ui/commit/eb2cb781aa2adf8fcc76a4e78514eac69a34cff3))
* **cli:** create seeded workspaces under Default workspace ([5045993](https://github.com/riccardo-forina/insights-rbac-ui/commit/5045993d89f6cb5acd7af461f93899f2418fc4f3))
* **common-auth:** current user cannot be disabled ([#1852](https://github.com/riccardo-forina/insights-rbac-ui/issues/1852)) ([e1af3a1](https://github.com/riccardo-forina/insights-rbac-ui/commit/e1af3a1ea7f8fdcec8eab9dca79080742d2a53c9))
* **common-auth:** org admins in users table ([#1774](https://github.com/riccardo-forina/insights-rbac-ui/issues/1774)) ([32997a0](https://github.com/riccardo-forina/insights-rbac-ui/commit/32997a0b3e37aa0f925c4877ba3030c0247aa77d))
* **common-auth:** remove invite message ([#1789](https://github.com/riccardo-forina/insights-rbac-ui/issues/1789)) ([5d808c5](https://github.com/riccardo-forina/insights-rbac-ui/commit/5d808c5ba27458798fda0cb081a9c70b5ec7676b))
* **common-auth:** use org ID ([#1757](https://github.com/riccardo-forina/insights-rbac-ui/issues/1757)) ([5ecb079](https://github.com/riccardo-forina/insights-rbac-ui/commit/5ecb079d46538f74c10a0ad0848ab533bf0b6695))
* **console:** address all warnings and errors ([6ba7480](https://github.com/riccardo-forina/insights-rbac-ui/commit/6ba74806fd4150c3201c9cddb96604efeabdc1fb))
* copy role wizard Next button stays disabled after validation ([740d52a](https://github.com/riccardo-forina/insights-rbac-ui/commit/740d52af75e346ca9d4a7f25e0d41efa8d62746b))
* correct move workspace notification message variables ([3b2af5b](https://github.com/riccardo-forina/insights-rbac-ui/commit/3b2af5b5bd08300bbb7d72bcd0f85e93bf698bf1))
* correctly render the Time created column for the service accounts ([25c830d](https://github.com/riccardo-forina/insights-rbac-ui/commit/25c830d1fb586d504feac0c24f766bb947db67fa))
* **cost-settings:** do not send resource definitions ([#1929](https://github.com/riccardo-forina/insights-rbac-ui/issues/1929)) ([0e5727c](https://github.com/riccardo-forina/insights-rbac-ui/commit/0e5727c85a38d2cfe0c70f843b0368ddcec07e09))
* crashes when running the app in dev mode ([f0a9942](https://github.com/riccardo-forina/insights-rbac-ui/commit/f0a994236eff2af3d1ce6fa01cd02691f4592e37))
* create user group button appears for any user with rbac:group:write ([6305bad](https://github.com/riccardo-forina/insights-rbac-ui/commit/6305bad885c46aa6f82eb1df7693cd6aef37d9cb))
* **create-workspace:** workspace selector can be enabled if hierarchy FF is on ([#1876](https://github.com/riccardo-forina/insights-rbac-ui/issues/1876)) ([baef26c](https://github.com/riccardo-forina/insights-rbac-ui/commit/baef26c680ab99a1ee295e279c3c4b8603ed31a6))
* **CreateGroupWizard:** display user friendly error messages ([9ffdc9d](https://github.com/riccardo-forina/insights-rbac-ui/commit/9ffdc9d1191eada8b48ce4f5e7ecc7e3fe1e138e))
* **CreateGroupWizard:** extend tests to verify service accounts creation ([d422ada](https://github.com/riccardo-forina/insights-rbac-ui/commit/d422adaa345b0656d96c918df62741533238a7aa))
* **cypress:** failing tests ([#1835](https://github.com/riccardo-forina/insights-rbac-ui/issues/1835)) ([5c4bef8](https://github.com/riccardo-forina/insights-rbac-ui/commit/5c4bef8f5a085bb6a928dbf33ef48c653573ff53))
* **debounce:** resolve flaky test and consolidate utilities ([e1b2cce](https://github.com/riccardo-forina/insights-rbac-ui/commit/e1b2cce0383e5594edbda1bc246c7695078f5ed6))
* **delete-ws:** fix delete workspace by styling it and properly sending request ([#1817](https://github.com/riccardo-forina/insights-rbac-ui/issues/1817)) ([b8b6d13](https://github.com/riccardo-forina/insights-rbac-ui/commit/b8b6d1311d6832994e3f56373b96a7b25ccf7a1d))
* **dependabot:** disable dependabot for weekly npm updates ([#1811](https://github.com/riccardo-forina/insights-rbac-ui/issues/1811)) ([e55e7ee](https://github.com/riccardo-forina/insights-rbac-ui/commit/e55e7ee237856e7c5202872de9a760d477b650e6))
* **deploy:** correct quay repository in frontend config ([#1693](https://github.com/riccardo-forina/insights-rbac-ui/issues/1693)) ([1f433e9](https://github.com/riccardo-forina/insights-rbac-ui/commit/1f433e927df2f3febc5301cedb775bdbea21caa8))
* **deploy:** correct quay repository in frontend config ([#1693](https://github.com/riccardo-forina/insights-rbac-ui/issues/1693)) ([800fbb7](https://github.com/riccardo-forina/insights-rbac-ui/commit/800fbb7bf3efec362ac3f08e7a690b3982f2b4c3))
* **deps:** bump tmp and inquirer ([#1915](https://github.com/riccardo-forina/insights-rbac-ui/issues/1915)) ([5484280](https://github.com/riccardo-forina/insights-rbac-ui/commit/5484280bc43c435c941283b1b5b8eee322c0f608))
* **deps:** update babel monorepo ([#1971](https://github.com/riccardo-forina/insights-rbac-ui/issues/1971)) ([b28803a](https://github.com/riccardo-forina/insights-rbac-ui/commit/b28803a8d9f7d90589b975d2fbd550ae889c2a23))
* **deps:** update babel monorepo to v7.28.5 ([24b371e](https://github.com/riccardo-forina/insights-rbac-ui/commit/24b371efc9ff6fb507173a9e7da1b38ad7dab97b))
* **deps:** update babel monorepo to v7.28.6 ([6033474](https://github.com/riccardo-forina/insights-rbac-ui/commit/60334740fa85eb8f9460da8373df5019f18f5a5b))
* **deps:** update dependency @formatjs/cli to v6.8.8 ([e1a60ad](https://github.com/riccardo-forina/insights-rbac-ui/commit/e1a60ad95565a71bcda7a56f3e31b35d53b4a2d6))
* **deps:** update dependency @redhat-cloud-services/frontend-components-utilities to v7.0.20 ([343cc09](https://github.com/riccardo-forina/insights-rbac-ui/commit/343cc09714dc88fe8e380cef9f39bed95e220e24))
* **deps:** update dependency @redhat-cloud-services/host-inventory-client to v4.1.7 ([f84a6e0](https://github.com/riccardo-forina/insights-rbac-ui/commit/f84a6e08e7ca97fd8a4f7e3ac77594026ad82a90))
* **deps:** update dependency react-router-dom to v6.30.2 ([dd8fdd5](https://github.com/riccardo-forina/insights-rbac-ui/commit/dd8fdd57b7cde1f2108dafe3d7fd6ec85f140e6c))
* **disable-users:** use user ID instead of user UUID ([#1927](https://github.com/riccardo-forina/insights-rbac-ui/issues/1927)) ([afefa4c](https://github.com/riccardo-forina/insights-rbac-ui/commit/afefa4c3b2d91382f25b294ca25f77172c48c185))
* do not checkout the repo from the GH cache action ([a7ee1fd](https://github.com/riccardo-forina/insights-rbac-ui/commit/a7ee1fdb25e777cd21e5ffd2bfd468690554e10b))
* **docs:** address CodeRabbit review feedback ([51ca895](https://github.com/riccardo-forina/insights-rbac-ui/commit/51ca8953d696e126522044058f08a723e5e44795))
* **docs:** address second-round CodeRabbit feedback on UserJourneys.mdx ([885cff1](https://github.com/riccardo-forina/insights-rbac-ui/commit/885cff1b5930ca66dc82201fb1bfba84498088b5))
* **docs:** fix groupMembers type and AGENTS.md link in docs ([0a9ee20](https://github.com/riccardo-forina/insights-rbac-ui/commit/0a9ee20ab68085235a27645c22b6345db9e8cc43))
* **docs:** replace waitFor async callbacks and delay() with findBy* in UserJourneys examples ([e17e0cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/e17e0cd8dc2b1c1cf8032072832a5e720de4fee8))
* **e2e:** update V2 tests for drawer and page-based patterns ([89134bd](https://github.com/riccardo-forina/insights-rbac-ui/commit/89134bd84c75616d52f4cfa69c4ae91aa727f53d))
* **EditUserGroup:** make test less flakey ([97f126d](https://github.com/riccardo-forina/insights-rbac-ui/commit/97f126ddb957798433277896c3734be91c68d721))
* eliminate page freeze from unstable getUser/getToken in useEffect deps ([ac35d0c](https://github.com/riccardo-forina/insights-rbac-ui/commit/ac35d0c9f46392f990f1d3ca1aec1aa92546a33b))
* eliminate Storybook test flakiness and enforce best practices ([98c11a8](https://github.com/riccardo-forina/insights-rbac-ui/commit/98c11a82946fa51c8f59b5273962ed00b11ac51d))
* enforce Kessel permission guards across workspace surfaces ([38694bf](https://github.com/riccardo-forina/insights-rbac-ui/commit/38694bf5711bdace04c8cda68ed5fe0b84c907fe))
* enforce parent workspace validation in create wizard ([d2e56a0](https://github.com/riccardo-forina/insights-rbac-ui/commit/d2e56a0823c0cdf12dc864fd75dce0eefd5f08b6))
* **feo:** removing ciam app data ([#1910](https://github.com/riccardo-forina/insights-rbac-ui/issues/1910)) ([5f5e609](https://github.com/riccardo-forina/insights-rbac-ui/commit/5f5e609b640502b2d2fd71a1f2eb0d635bc1d193))
* fetch all workspaces by default ([#1846](https://github.com/riccardo-forina/insights-rbac-ui/issues/1846)) ([7def691](https://github.com/riccardo-forina/insights-rbac-ui/commit/7def6910925a270d43604b92148ad12e46a470a4))
* fix broken cypress tests ([f8a88d0](https://github.com/riccardo-forina/insights-rbac-ui/commit/f8a88d0231b951ea4471af6c2f308dfc78ed4484))
* fix OOM on CI ([d835a6a](https://github.com/riccardo-forina/insights-rbac-ui/commit/d835a6ae3e1231ab6b181eba5062f4054332a976))
* fix swc error on CI ([b6e0493](https://github.com/riccardo-forina/insights-rbac-ui/commit/b6e04934470d4b8eb534d9be3be8085af3d6c641))
* fix typo and update snapshots ([67923e9](https://github.com/riccardo-forina/insights-rbac-ui/commit/67923e98223249eed39edcb5b4158d1a2d025d81))
* fix users-and-user-groups E2E ([14dcf89](https://github.com/riccardo-forina/insights-rbac-ui/commit/14dcf89a4ca61c4ae99255c328a62d74bc046b88))
* fixed bug with filters in permissions table of create role wizard ([6daa692](https://github.com/riccardo-forina/insights-rbac-ui/commit/6daa692cb778275158dae36a17a58550cdb51b4f))
* flag the selected group as not a plat default after a change ([559c3eb](https://github.com/riccardo-forina/insights-rbac-ui/commit/559c3ebffb0812394f0982c52ffaef48415ac062))
* flaky AddGroupMembers WithFiltering test ([7b152aa](https://github.com/riccardo-forina/insights-rbac-ui/commit/7b152aa4705453abc24d23a49eafd65693196996))
* gate all workspace detail role-binding actions on Kessel permissions ([11df128](https://github.com/riccardo-forina/insights-rbac-ui/commit/11df1287b77fdb9992cb893c15dae11c92cfb228))
* gate Grant access button on Kessel create permission in roles tab ([63e51a5](https://github.com/riccardo-forina/insights-rbac-ui/commit/63e51a5bcc5f0788160fe8f79ecb0221623565ff))
* **grantaccesswizard:** internationalize wizard labels ([fbcba6f](https://github.com/riccardo-forina/insights-rbac-ui/commit/fbcba6f5141aa61295d2c456e0502375601c29f2))
* **GrantAccessWizard:** update branch ([7eb8903](https://github.com/riccardo-forina/insights-rbac-ui/commit/7eb8903fe4d0bd40d72c9d2e27b16455334959a9))
* **GrantAccessWizard:** update roles step description ([728b9da](https://github.com/riccardo-forina/insights-rbac-ui/commit/728b9da8dd49504196241d187444ea386734d751))
* **groups:** adding and removing users from group ([#1907](https://github.com/riccardo-forina/insights-rbac-ui/issues/1907)) ([2e66610](https://github.com/riccardo-forina/insights-rbac-ui/commit/2e66610b5cdd43d78cdf8e15afb7f51d6f084411))
* **Groups:** restore warning dialog when changing Default Group ([3222086](https://github.com/riccardo-forina/insights-rbac-ui/commit/3222086924ffbd07bdddfcd35820271c0a35f993))
* handle case of undefined group ([#1782](https://github.com/riccardo-forina/insights-rbac-ui/issues/1782)) ([f4021f1](https://github.com/riccardo-forina/insights-rbac-ui/commit/f4021f170d990aa07f375e4527f929becfccaaa2))
* handle empty responses from Akamai for the potentially optional cost API ([#1834](https://github.com/riccardo-forina/insights-rbac-ui/issues/1834)) ([4f6afcf](https://github.com/riccardo-forina/insights-rbac-ui/commit/4f6afcf45482597a8fdbe57c9a4a8cc2881db3d1))
* hide service accounts table for default admin access ([#1709](https://github.com/riccardo-forina/insights-rbac-ui/issues/1709)) ([1452179](https://github.com/riccardo-forina/insights-rbac-ui/commit/1452179da1a55c17c486aed55d23e3a1a7e48285))
* inventory API integration and add filtering tests ([a8f8edf](https://github.com/riccardo-forina/insights-rbac-ui/commit/a8f8edf13487f65eead76cf7f22ff798098a5e5f))
* **invite:** by adding locale ([#1759](https://github.com/riccardo-forina/insights-rbac-ui/issues/1759)) ([c11e179](https://github.com/riccardo-forina/insights-rbac-ui/commit/c11e179995b5476b5a8730c80bb1866a20aaa8ba))
* issues with merge commit ([84917d3](https://github.com/riccardo-forina/insights-rbac-ui/commit/84917d3caab81a7970f80f148d3f9252582eb746))
* **itless:** fix itless users activate dropdown ([#1856](https://github.com/riccardo-forina/insights-rbac-ui/issues/1856)) ([43b26dc](https://github.com/riccardo-forina/insights-rbac-ui/commit/43b26dc9d3d6523e660a4d6022ce764a966b4d06))
* key prop spreading error ([25340d6](https://github.com/riccardo-forina/insights-rbac-ui/commit/25340d65cae9fb0835aea40d2359f15747c59899))
* **konflux:** add rpms check to pull requests ([#1691](https://github.com/riccardo-forina/insights-rbac-ui/issues/1691)) ([81d51ff](https://github.com/riccardo-forina/insights-rbac-ui/commit/81d51fffbabaf08a4fa3a7461d0bba31407d892d))
* **konflux:** add rpms check to pull requests ([#1691](https://github.com/riccardo-forina/insights-rbac-ui/issues/1691)) ([981c7ce](https://github.com/riccardo-forina/insights-rbac-ui/commit/981c7ceae4bc46143f703f666484e2cea4338469))
* **konflux:** failing konflux build by removing JAVA references ([#1743](https://github.com/riccardo-forina/insights-rbac-ui/issues/1743)) ([76bc417](https://github.com/riccardo-forina/insights-rbac-ui/commit/76bc4171ac08ab2ecbae61b52634ce868c7d2c97))
* **konflux:** remove duplicate name of task ([#1723](https://github.com/riccardo-forina/insights-rbac-ui/issues/1723)) ([991729a](https://github.com/riccardo-forina/insights-rbac-ui/commit/991729a25b0121bda9802c762cb707e3a4757aa2))
* **konflux:** remove sbom json check ([#1722](https://github.com/riccardo-forina/insights-rbac-ui/issues/1722)) ([9fe1bce](https://github.com/riccardo-forina/insights-rbac-ui/commit/9fe1bcefd693fa180631164c10c9bd28f51d91d3))
* **konflux:** update buildah image sha ([#1719](https://github.com/riccardo-forina/insights-rbac-ui/issues/1719)) ([7d637b8](https://github.com/riccardo-forina/insights-rbac-ui/commit/7d637b801e731a7f5a88fb97e4d9062b18412d7c))
* **konflux:** update oci-ta and rpms scan image dependencies ([#1720](https://github.com/riccardo-forina/insights-rbac-ui/issues/1720)) ([1b2cf81](https://github.com/riccardo-forina/insights-rbac-ui/commit/1b2cf8171fb64ce0f3417335dbfda54b4e988973))
* lint ([516279f](https://github.com/riccardo-forina/insights-rbac-ui/commit/516279f3aa346dcd01d8a66cd3aa0aa15a77f04b))
* lint issues in ProductionOrgAdmin ([dcc41cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/dcc41cd7658a8b4ad11a2887ac324ee10eb0ad40))
* **lint:** remove import ([f4baac8](https://github.com/riccardo-forina/insights-rbac-ui/commit/f4baac8f97bb477b859a9f1959b8c34020b81fa0))
* localize name filter strings ([0832973](https://github.com/riccardo-forina/insights-rbac-ui/commit/0832973c09fe7962a3c09c638510fefb9b3b2f8c))
* made updates based on sourcery-ai comments ([aaa45f9](https://github.com/riccardo-forina/insights-rbac-ui/commit/aaa45f9eff0c445d5c9e86438acb6fdf7e008a8c))
* made updates based on sourcery-ai comments ([2e49568](https://github.com/riccardo-forina/insights-rbac-ui/commit/2e49568b1991a9dd28b44437a72bfee82f6030ab))
* make FakeAddressBar visible in user journey stories ([457ee96](https://github.com/riccardo-forina/insights-rbac-ui/commit/457ee96ba4b3589314d501338c0522f3879f97b2))
* **managed-ws:** add unit and e2e tests to managed WS ([edc80ca](https://github.com/riccardo-forina/insights-rbac-ui/commit/edc80cac452c3f039046b36fa33dc1143cf06104))
* **many:** clear filters now working across the board ([1ab8e2b](https://github.com/riccardo-forina/insights-rbac-ui/commit/1ab8e2b4daaf729e686ff48cdb83e63a4268958f))
* memoize users row data ([60deb9b](https://github.com/riccardo-forina/insights-rbac-ui/commit/60deb9b76285d3b6899ebe59d8d849f92ae9a384))
* more lint ([3d3d870](https://github.com/riccardo-forina/insights-rbac-ui/commit/3d3d87006b0a6ffefb2bc1ac7ee3765b52f8740a))
* **MyAccess:** add sorting to mygroups and myworkspaces tables ([3964c57](https://github.com/riccardo-forina/insights-rbac-ui/commit/3964c5734b34f3045100a20bbbfd6fe33fa1c3b0))
* **MyAccess:** lint ([823a104](https://github.com/riccardo-forina/insights-rbac-ui/commit/823a1042d3a940e50467f28a6b8ff58086537c58))
* **MyWorkspaces:** fix loading issue ([222808a](https://github.com/riccardo-forina/insights-rbac-ui/commit/222808a5ee4118736048b89bf4a2106457494d37))
* **MyWorkspaces:** remove potential inifite loading issue ([b7e7b7e](https://github.com/riccardo-forina/insights-rbac-ui/commit/b7e7b7e66b668b49699d1bea10e058f5c2eb27dd))
* **nav:** change pathname ([#2106](https://github.com/riccardo-forina/insights-rbac-ui/issues/2106)) ([7f5002f](https://github.com/riccardo-forina/insights-rbac-ui/commit/7f5002f866b27b3c73e9d3984ec3fd20b237fd5c))
* **navigation:** remove explicit bundleSegment for service-accounts and learning resources ([#2096](https://github.com/riccardo-forina/insights-rbac-ui/issues/2096)) ([79e16bf](https://github.com/riccardo-forina/insights-rbac-ui/commit/79e16bfe54689d48993996c6208c0d2fbcac6b09))
* **navigation:** remove redundant service-accounts entry ([426b24a](https://github.com/riccardo-forina/insights-rbac-ui/commit/426b24a365289edac2235991c4199828b7d25239))
* **nav:** use OR logic for permission checks in navigation ([b77c7d6](https://github.com/riccardo-forina/insights-rbac-ui/commit/b77c7d6da5a6a96ffd871ca76bc25c40adae125c))
* **org admin:** marking user org admin with correct ID ([#1756](https://github.com/riccardo-forina/insights-rbac-ui/issues/1756)) ([31606bb](https://github.com/riccardo-forina/insights-rbac-ui/commit/31606bb17750cb2bbcbd2d84a85b7ea7aa60d0fa))
* pairing this down to minimal changes ([6ee97f5](https://github.com/riccardo-forina/insights-rbac-ui/commit/6ee97f5b6089dfe127f4eddb6a413913f12730d0))
* **permissions:** view WS list for users with groups read ([#1821](https://github.com/riccardo-forina/insights-rbac-ui/issues/1821)) ([9bc20af](https://github.com/riccardo-forina/insights-rbac-ui/commit/9bc20afd7ed7868dea79df7e7366dd0073bf0d9a))
* **permission:** unable to load more than 2 pages in permissions ([#1688](https://github.com/riccardo-forina/insights-rbac-ui/issues/1688)) ([f150391](https://github.com/riccardo-forina/insights-rbac-ui/commit/f150391edead6b54b4c8255706024a1f09126f49))
* **permission:** unable to load more than 2 pages in permissions ([#1688](https://github.com/riccardo-forina/insights-rbac-ui/issues/1688)) ([2d08c25](https://github.com/riccardo-forina/insights-rbac-ui/commit/2d08c25204ab35488a01c1c05cb51c942f244510))
* prevent 'Add role to this group' link showing for admin group during loading ([756eb0d](https://github.com/riccardo-forina/insights-rbac-ui/commit/756eb0d009adf24e0837d9f4f0bd067375c9039f))
* prevent unauthorized API calls causing error toast spam for non-admin users ([55e0ddc](https://github.com/riccardo-forina/insights-rbac-ui/commit/55e0ddc662ce6069c40624c81cc2bcdff8235d16))
* **productionOrgAdmin:** fix lint ([7088cb2](https://github.com/riccardo-forina/insights-rbac-ui/commit/7088cb29c1f8deed41dae4d497e7fd05201ccd29))
* **providers:** add missing ServiceProvider to Iam component ([56c0a10](https://github.com/riccardo-forina/insights-rbac-ui/commit/56c0a1090f7e72ba632f4a6b9871d9432ead2b14))
* **release:** fix release ([04b5593](https://github.com/riccardo-forina/insights-rbac-ui/commit/04b55936a99c38324af6458877da86265185b2eb))
* remove delay(300) before table render in sorting test ([c4fb616](https://github.com/riccardo-forina/insights-rbac-ui/commit/c4fb616780b3501f5d8b0dc296e50bfd6ba67070))
* remove legacy role components and fix Storybook test selectors ([73b302f](https://github.com/riccardo-forina/insights-rbac-ui/commit/73b302fd5aa5551c623e80c3ebb11b948c94488b))
* remove mapStateToProps and mapDispatchToProps ([d9179d6](https://github.com/riccardo-forina/insights-rbac-ui/commit/d9179d636346c3cbb00401820254ed00ff88de41))
* remove non-existent `rename` Kessel relation, use `edit` ([8d83cb7](https://github.com/riccardo-forina/insights-rbac-ui/commit/8d83cb70aef0d78f119039f8a642c5be4ece8ba5))
* remove openshift asset from WS details ([#1890](https://github.com/riccardo-forina/insights-rbac-ui/issues/1890)) ([8a742fe](https://github.com/riccardo-forina/insights-rbac-ui/commit/8a742fe409a6890ea60355c49a25e3d7f3554e69))
* remove redundant User Jest test (covered by 15 Storybook tests) ([e2fcf0e](https://github.com/riccardo-forina/insights-rbac-ui/commit/e2fcf0e504e8b6f1f4470f6c49561ec5e2a34384))
* remove unsupported Jest flags from Tekton push pipeline ([30bb271](https://github.com/riccardo-forina/insights-rbac-ui/commit/30bb271399fc888dd425ab0bc62b0f0b53c5841a))
* remove unused @redhat-cloud-services/cost-management-client and update axios to 1.12.0 ([88a42e9](https://github.com/riccardo-forina/insights-rbac-ui/commit/88a42e9e3c402c10386b036ce856a72ee22d638e))
* remove withRouter decorators ([5b17ed2](https://github.com/riccardo-forina/insights-rbac-ui/commit/5b17ed29b8a56abd124257d11d62b033c930e45c))
* removed some unnecessary things / file that shouldn't have been tracked ([d2771cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/d2771cdc2cf523a162a126fbb4fb5b077f46a7e6))
* rename groups.scss to Groups.scss for case sensitivity ([f003895](https://github.com/riccardo-forina/insights-rbac-ui/commit/f003895d37c4adecaabbbbc48bf0cc19a0b24189))
* rename V1 overview nav ID to resolve collision with V2 ([8bcce48](https://github.com/riccardo-forina/insights-rbac-ui/commit/8bcce48c22620c52de2d4d4cd5013b32c2b9e279))
* rename V2 my-access route and fix roles table width ([742083a](https://github.com/riccardo-forina/insights-rbac-ui/commit/742083a1adc3dda29eec3f4b64a72e91a5e18bcb))
* replace useRouteMatch with useParams ([d23a2a2](https://github.com/riccardo-forina/insights-rbac-ui/commit/d23a2a25469e821d41ac14bb70b396f43402db53))
* resolve merge ([5a8c3b4](https://github.com/riccardo-forina/insights-rbac-ui/commit/5a8c3b4d43c55a558b9b7fa6bcbceaa041c8aff2))
* resource definition editing and wizard modal button layout ([5fce50e](https://github.com/riccardo-forina/insights-rbac-ui/commit/5fce50e5921ea443b03f8897b33244abfc26b1a6))
* **RHCLOUD-41224:** correct IAM learning resources link and text ([#1948](https://github.com/riccardo-forina/insights-rbac-ui/issues/1948)) ([e4fe13a](https://github.com/riccardo-forina/insights-rbac-ui/commit/e4fe13ad6627ff47ae94b9af13b36fbb48c782a8))
* **RHCLOUD-42361:** correct 'Learn more about workspaces' link URL ([#1949](https://github.com/riccardo-forina/insights-rbac-ui/issues/1949)) ([bda6768](https://github.com/riccardo-forina/insights-rbac-ui/commit/bda676892bbcf2d24a8dde0961c760bd56561649))
* **role wizard:** unflip workspace flag ([9807831](https://github.com/riccardo-forina/insights-rbac-ui/commit/9807831ab82e75ab12e29b14fc688124a53b6931))
* **RoleBinding:** fixed typescript errors and flakey tests ([2620719](https://github.com/riccardo-forina/insights-rbac-ui/commit/26207196206a6a3fab95afb8b65b6f62b59c11ce))
* **RoleBinding:** lint ([63570f9](https://github.com/riccardo-forina/insights-rbac-ui/commit/63570f955bab4abf84c5a96e5d2e6d91241fb87f))
* **RoleResourceDefinitions:** optimize selectors to prevent re-renders ([5a78f48](https://github.com/riccardo-forina/insights-rbac-ui/commit/5a78f48da77e7b9d36348868effade73fdc6dfcb))
* **roles:** add-role wizard Exit navigates to correct V2 roles path ([5438911](https://github.com/riccardo-forina/insights-rbac-ui/commit/54389112a836344a602825a12c03e036a6d0389b))
* **roles:** align filtering + resource definition UX ([#2021](https://github.com/riccardo-forina/insights-rbac-ui/issues/2021)) ([3bfa514](https://github.com/riccardo-forina/insights-rbac-ui/commit/3bfa5149f280bb8a730f44ee5c8d48f40802ea6d))
* **rolesdrawer:** replace a tag with applink ([b80e6e8](https://github.com/riccardo-forina/insights-rbac-ui/commit/b80e6e8783a74a5761d805e988d48b524fb6f54b))
* **Roles:** fix nav for editing roles ([66ebd75](https://github.com/riccardo-forina/insights-rbac-ui/commit/66ebd758eb6088ba2a98c3f4e49452600cb8cfca))
* **roles:** remove debug console.log from EditRole form renderer ([ed4eb46](https://github.com/riccardo-forina/insights-rbac-ui/commit/ed4eb46db5489f8c3daaa724616d917780c407c1))
* **roles:** when navigating from my user access ([#1904](https://github.com/riccardo-forina/insights-rbac-ui/issues/1904)) ([2b6af9b](https://github.com/riccardo-forina/insights-rbac-ui/commit/2b6af9bf0b8c8128a40ef4b77f4b848fe63a6d49))
* **rolewizard:** clean up some types ([023f76d](https://github.com/riccardo-forina/insights-rbac-ui/commit/023f76d068e5f20161e6bfe9b7c9a4ddd502a803))
* **rolewizard:** convert add role wizard to typescript ([a7b627b](https://github.com/riccardo-forina/insights-rbac-ui/commit/a7b627b3e918242f1ea9c0f8594cb6747927b424))
* **rolewizard:** delete js version of wizard context ([632004d](https://github.com/riccardo-forina/insights-rbac-ui/commit/632004df20177f69030427a693bf26c241b88657))
* **routing:** align access-management routes with navigation feature flags ([4c5f4cf](https://github.com/riccardo-forina/insights-rbac-ui/commit/4c5f4cf8a74149dc935918617b1dfd3d91a3eb62))
* run npx playwright install before running the tests for PRs ([c20a44a](https://github.com/riccardo-forina/insights-rbac-ui/commit/c20a44aa65171b8984b5d4e5a2134e01d266a60e))
* **service-accounts:** assign, list and delete from group ([#1901](https://github.com/riccardo-forina/insights-rbac-ui/issues/1901)) ([727a976](https://github.com/riccardo-forina/insights-rbac-ui/commit/727a976eeea501dccb022cac23c51b26276619ce))
* **serviceaccountslist:** make table compact ([c139d17](https://github.com/riccardo-forina/insights-rbac-ui/commit/c139d1721dba23dc1ef34f3a9eb33320ae0fb5af))
* simplified things and began noting AI agent usage ([94687e6](https://github.com/riccardo-forina/insights-rbac-ui/commit/94687e69ca2cc676217ef000903d6a745af450d5))
* started simplifying unneeded changes ([4e4d781](https://github.com/riccardo-forina/insights-rbac-ui/commit/4e4d781917a4dcd8dc0ff5ff903ccf06fe36a727))
* **stories:** expand tree before asserting child workspace states ([9de84b0](https://github.com/riccardo-forina/insights-rbac-ui/commit/9de84b0293df03dbda2ca30e951d899f879b9803))
* **storybook:** adjust WS storybooks to match rolebinding endpoint ([3d2f01a](https://github.com/riccardo-forina/insights-rbac-ui/commit/3d2f01afa674e7e1f8e2a8656d4fb77258c7b77b))
* **storybook:** fix failing M3 workspace details test ([af00806](https://github.com/riccardo-forina/insights-rbac-ui/commit/af008068303d5b0e2a7decae5b94306dfd20fb9d))
* **storybook:** fix flaky tests by using async queries ([28d6e02](https://github.com/riccardo-forina/insights-rbac-ui/commit/28d6e02e29da829021aa09511713177823e066ff))
* **storybook:** fix navigation test null console error ([4754e17](https://github.com/riccardo-forina/insights-rbac-ui/commit/4754e17a7078d4fccd4cc2308bae41e33439197b))
* **Storybook:** remove unsilence assertion ([fbce0c0](https://github.com/riccardo-forina/insights-rbac-ui/commit/fbce0c0cf79d720cb7d115a0c214bfa4c073deff))
* **storybook:** remove waitFor timeouts; fix failing tests ([ba6aeb6](https://github.com/riccardo-forina/insights-rbac-ui/commit/ba6aeb64fb564c9b00645f0d5d58778522669922))
* **storybook:** simplify ManualTestingStory play function ([8ebff4c](https://github.com/riccardo-forina/insights-rbac-ui/commit/8ebff4cfe7c51c88f1c7a8c5b5b07e487a5c6f7f))
* test-storybook must run on the same code used by chromatic-deployment ([2902d20](https://github.com/riccardo-forina/insights-rbac-ui/commit/2902d201a28466631736da5dc93c08d9a080c154))
* **test:** lint ([d95a966](https://github.com/riccardo-forina/insights-rbac-ui/commit/d95a966438bbaab1237df090cc95d4e88d625dc1))
* **tests:** correct Storybook play tests for confirmation modals ([9059b22](https://github.com/riccardo-forina/insights-rbac-ui/commit/9059b22888b00e48afb339a42667219da1cae56f))
* **tests:** fix console errors in storybook stories ([116813d](https://github.com/riccardo-forina/insights-rbac-ui/commit/116813deccabe6d317d5ac877ba2b67e0b51c45d))
* **tests:** update snapshots ([34a97ee](https://github.com/riccardo-forina/insights-rbac-ui/commit/34a97ee5034e0721e43c96012d0626fa8e3e7139))
* **test:** update snapshot ([dbe7c36](https://github.com/riccardo-forina/insights-rbac-ui/commit/dbe7c36b7bfac22b44c5cc1a6c03ff648740783f))
* tighten cross-version import boundary to cover all src/ paths ([e6cedbb](https://github.com/riccardo-forina/insights-rbac-ui/commit/e6cedbb3c7cb6ba2d5b2d3c4a109acd10835f5b3))
* **tiles:** permissions for tiles are fixed ([#1961](https://github.com/riccardo-forina/insights-rbac-ui/issues/1961)) ([531e3cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/531e3cd00392e7daf6c63ae6b007dc9c2a76266c))
* **toolbar:** selection by using callback only ([#1885](https://github.com/riccardo-forina/insights-rbac-ui/issues/1885)) ([8905442](https://github.com/riccardo-forina/insights-rbac-ui/commit/890544286c772422854d608d58d3a3c33f64cfa1))
* tweak MUA mobile/tablet breakpoints ([1d30265](https://github.com/riccardo-forina/insights-rbac-ui/commit/1d30265e3c58e846d0184c51a5a7c1f4f29c9ec2))
* **typescript:** do not run typescript for test files ([55cfeb3](https://github.com/riccardo-forina/insights-rbac-ui/commit/55cfeb393f6362802957da3e86415a58c6f2fb1a))
* **types:** use casting to unknown and to request type instead of any ([df6859b](https://github.com/riccardo-forina/insights-rbac-ui/commit/df6859b6205d5f48fe9e81fd393ad6d7686acd45))
* update 'user management - invite user' text ([d8753aa](https://github.com/riccardo-forina/insights-rbac-ui/commit/d8753aa1011a8d188437a24fc1c04f9532f5be37))
* update background image path in overview component ([#1934](https://github.com/riccardo-forina/insights-rbac-ui/issues/1934)) ([42e576d](https://github.com/riccardo-forina/insights-rbac-ui/commit/42e576da03e208341cc67169b62d58cf169c4696))
* update iam.svg url ([#1898](https://github.com/riccardo-forina/insights-rbac-ui/issues/1898)) ([b8a49c4](https://github.com/riccardo-forina/insights-rbac-ui/commit/b8a49c42bb2c72bd66a4b6df39857b58a3978e7f))
* update snapshots; localize string ([24a5d42](https://github.com/riccardo-forina/insights-rbac-ui/commit/24a5d42bb235a1ddd9b3e13d486d6bd9abfbba75))
* update tests for TableView migration ([b0f17fe](https://github.com/riccardo-forina/insights-rbac-ui/commit/b0f17fe02ca924b6700fcc1590c78603bf8ba38b))
* upgrade utility classes to PF5 ([750a18a](https://github.com/riccardo-forina/insights-rbac-ui/commit/750a18a60cdeacbee029b70ff1e7920f7b83e8f3))
* use correct granular permissions for each route ([e5012a3](https://github.com/riccardo-forina/insights-rbac-ui/commit/e5012a325b813ba989c05f292938dc2e05859b2e))
* use inline style when calling workspaces api ([#1845](https://github.com/riccardo-forina/insights-rbac-ui/issues/1845)) ([3cdae15](https://github.com/riccardo-forina/insights-rbac-ui/commit/3cdae15d1e51a476ee5bee1361ac78c191279857))
* use node lts ([772a3e4](https://github.com/riccardo-forina/insights-rbac-ui/commit/772a3e410d48342b595ce41388109f154579b834))
* user with user access admin role allowed to write to groups page ([f5953c5](https://github.com/riccardo-forina/insights-rbac-ui/commit/f5953c5e9d33b471da3936500dca63ce13ce8030))
* **user-journeys:** correct V2 sidebar nav assertions ([faac1b6](https://github.com/riccardo-forina/insights-rbac-ui/commit/faac1b660fbb9e514be9f8734fde8e82a7da540d))
* **UserAccess:** make user access cards look selected ([#1727](https://github.com/riccardo-forina/insights-rbac-ui/issues/1727)) ([2e58c45](https://github.com/riccardo-forina/insights-rbac-ui/commit/2e58c458ec9d9e529a1c953a7f8b5b941871165e))
* **users:** remove /management prefix from IT API URLs ([a29a4e5](https://github.com/riccardo-forina/insights-rbac-ui/commit/a29a4e570f053ceba670862e7a9f3f8002aa0b7d))
* workspace selector styling ([#1873](https://github.com/riccardo-forina/insights-rbac-ui/issues/1873)) ([eb491ca](https://github.com/riccardo-forina/insights-rbac-ui/commit/eb491ca5777e297022eee629f28a0dff84c5b3f2))
* **WorkspaceList:** expand Workspace tree by default ([fcda8cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/fcda8cd0d51d2d8ece7c3c7650fbf7257ff70547))
* **WorkspaceSelector:** keep dropdown width from expanding ([8ea46d7](https://github.com/riccardo-forina/insights-rbac-ui/commit/8ea46d75d84ef11b300fb838f318cd8dbb696c5b))
* **workspaces:** use official API types and fix React hooks violation ([32ef97e](https://github.com/riccardo-forina/insights-rbac-ui/commit/32ef97eec2867f06e48bbfe6052bb104c865e5b8))
* **ws-detail:** do not use as any while going trough rolebinding response ([7372bbd](https://github.com/riccardo-forina/insights-rbac-ui/commit/7372bbdb67bc0f7be8cbff8157bd8e385fbc9910))
* **ws:** filter by showing children of found nodes ([#1882](https://github.com/riccardo-forina/insights-rbac-ui/issues/1882)) ([a4532a5](https://github.com/riccardo-forina/insights-rbac-ui/commit/a4532a5342e5446227fea983dcd317501d823bf8))
* **WS:** raise WS limit to 10k ([#1841](https://github.com/riccardo-forina/insights-rbac-ui/issues/1841)) ([c7f50d7](https://github.com/riccardo-forina/insights-rbac-ui/commit/c7f50d75d62b01a98d288a407993755059ac6502))


### Features

* **access-management:** complete feature implementation with V2 API gap documentation ([3adf5c8](https://github.com/riccardo-forina/insights-rbac-ui/commit/3adf5c8947ca1d4835c1bd868d78111a8e3a69d2))
* **access-management:** wire Invite Users in Access Management Users tab ([015cdb6](https://github.com/riccardo-forina/insights-rbac-ui/commit/015cdb6ccb50c86ac5d4eb750d7dc6744775349a))
* add correct routing path ([bd34fd1](https://github.com/riccardo-forina/insights-rbac-ui/commit/bd34fd1bb02fa205b734272d2983343f77f0346a))
* add create user group to user group list ([#1713](https://github.com/riccardo-forina/insights-rbac-ui/issues/1713)) ([6c4cd82](https://github.com/riccardo-forina/insights-rbac-ui/commit/6c4cd824ac893aaf9b367f3a78865e2da26f3e00))
* add cypress test Make user an org admin ([#1796](https://github.com/riccardo-forina/insights-rbac-ui/issues/1796)) ([4bf69cc](https://github.com/riccardo-forina/insights-rbac-ui/commit/4bf69ccfa5ce0f039f4484614dd6792bb60a0965))
* add detailed view to Workspaces ([#1682](https://github.com/riccardo-forina/insights-rbac-ui/issues/1682)) ([2f1efc1](https://github.com/riccardo-forina/insights-rbac-ui/commit/2f1efc1fdff0cdd77972b479d3d5a12ad300c204))
* add disabled edit access button to WS details drawer ([#1918](https://github.com/riccardo-forina/insights-rbac-ui/issues/1918)) ([8b59ac4](https://github.com/riccardo-forina/insights-rbac-ui/commit/8b59ac4666c993fbc35c7c7fb509f632eb03c68d))
* add disabled grant access button to WS details ([#1906](https://github.com/riccardo-forina/insights-rbac-ui/issues/1906)) ([b5772d4](https://github.com/riccardo-forina/insights-rbac-ui/commit/b5772d4c5a705e7a7ca9bbd5d545559c6138de97))
* add dropdown to make user an org admin workspaces ([#1771](https://github.com/riccardo-forina/insights-rbac-ui/issues/1771)) ([b73a7f2](https://github.com/riccardo-forina/insights-rbac-ui/commit/b73a7f2a3ba221cf8cf31b1b3848b0f1b9bf0f5b))
* add empty and leading states for Roles table ([#1750](https://github.com/riccardo-forina/insights-rbac-ui/issues/1750)) ([c0d3ef4](https://github.com/riccardo-forina/insights-rbac-ui/commit/c0d3ef4d3227308860de2b6f97aa67972900fd2a))
* add empty new edit role page ([#1795](https://github.com/riccardo-forina/insights-rbac-ui/issues/1795)) ([2276b4f](https://github.com/riccardo-forina/insights-rbac-ui/commit/2276b4f310a75aed91d3e4920b5ace273ff619ed))
* add empty state and loading state to Users & User Groups ([#1707](https://github.com/riccardo-forina/insights-rbac-ui/issues/1707)) ([92ea430](https://github.com/riccardo-forina/insights-rbac-ui/commit/92ea430d3c461f11fa2428588e687fde4cab55c4))
* add initial ws selector module ([c44a11e](https://github.com/riccardo-forina/insights-rbac-ui/commit/c44a11edbdfcbe1224c05d50c1e0139cf5d6e12a))
* add lightspeed rebrand ([#1989](https://github.com/riccardo-forina/insights-rbac-ui/issues/1989)) ([6ad3f96](https://github.com/riccardo-forina/insights-rbac-ui/commit/6ad3f968cd0d8d6a25e20db516237e5be90051af))
* add message and link to role binding detail ([#2013](https://github.com/riccardo-forina/insights-rbac-ui/issues/2013)) ([9b51ee5](https://github.com/riccardo-forina/insights-rbac-ui/commit/9b51ee5a1ac427dff93af3fa5dceb3788d2d7784))
* add organization management page ([add41ae](https://github.com/riccardo-forina/insights-rbac-ui/commit/add41ae76471cdcb8a96087103651eb0b51baefe))
* add role bindings table to org-management ([a8dbad0](https://github.com/riccardo-forina/insights-rbac-ui/commit/a8dbad02556bcdf33db04781cf7f63e5aa637799))
* add Root Workspace as parent of Default Workspace in fixtures ([d8cc193](https://github.com/riccardo-forina/insights-rbac-ui/commit/d8cc193d3ea6a06726ce51f054b05f470cc7e18d))
* add route permission validation to prevent drift ([64d00d8](https://github.com/riccardo-forina/insights-rbac-ui/commit/64d00d8b6f53f6f6fb150a6d033cc4eee386af56))
* add user viewer journeys and fix test flakiness ([e2a40c4](https://github.com/riccardo-forina/insights-rbac-ui/commit/e2a40c426207892b51253e71335a74d3456d13d5))
* add workspaces to iam section of services dropdown ([#1833](https://github.com/riccardo-forina/insights-rbac-ui/issues/1833)) ([5dd5fd9](https://github.com/riccardo-forina/insights-rbac-ui/commit/5dd5fd98a023667e185587eefb2941281c94f98b))
* automatic headless login for the cli ([7f84b95](https://github.com/riccardo-forina/insights-rbac-ui/commit/7f84b9591bb35df739e90636b3141bbe21b4f73b))
* **build-tools:** migrate to build tools ([#1769](https://github.com/riccardo-forina/insights-rbac-ui/issues/1769)) ([cca1d2f](https://github.com/riccardo-forina/insights-rbac-ui/commit/cca1d2f8f1466217f91c5f66063fd8a6f7bbb92a))
* centralize the pagination clamping check and logic to TableView ([f25c366](https://github.com/riccardo-forina/insights-rbac-ui/commit/f25c366c4e23476efad62c0b61c3214897ec3896))
* **cli:** add terminal UI for RBAC management using react-ink ([7e96837](https://github.com/riccardo-forina/insights-rbac-ui/commit/7e9683725e0e74b01de3c8d0eeb67a56ce998262))
* **cli:** fix TUI input focus and add comprehensive tests ([bc159cd](https://github.com/riccardo-forina/insights-rbac-ui/commit/bc159cd7f09b187c37cb1f8b752da3c18cba016e))
* **cli:** improve workspaces TUI with tree navigation ([7ab3603](https://github.com/riccardo-forina/insights-rbac-ui/commit/7ab36033c7f99b36e6a3919adb425d765e52dfa0))
* **codeowners:** update codeowners to experience-ui ([#1773](https://github.com/riccardo-forina/insights-rbac-ui/issues/1773)) ([2cf1f08](https://github.com/riccardo-forina/insights-rbac-ui/commit/2cf1f08977d62af8c20459dcb5d4202eee19eaa3))
* **common auth model:** add dropdown to make user an org admin ([#1740](https://github.com/riccardo-forina/insights-rbac-ui/issues/1740)) ([ac1b0f6](https://github.com/riccardo-forina/insights-rbac-ui/commit/ac1b0f6fb6ed1a46c68a36177d231ade9b729a71))
* **common-auth-model:** add mocked requests ([#1695](https://github.com/riccardo-forina/insights-rbac-ui/issues/1695)) ([966361c](https://github.com/riccardo-forina/insights-rbac-ui/commit/966361cb70c7bf4784d549a05d46eb43f82dfe59))
* **common-auth:** add it api to invite and edit users ([#1718](https://github.com/riccardo-forina/insights-rbac-ui/issues/1718)) ([0ac978c](https://github.com/riccardo-forina/insights-rbac-ui/commit/0ac978c95903f6a1a79cd82899f15cc405e56089))
* **common-auth:** add multi-select and active toggle to Users Table ([#1764](https://github.com/riccardo-forina/insights-rbac-ui/issues/1764)) ([6ff9f18](https://github.com/riccardo-forina/insights-rbac-ui/commit/6ff9f18cc7eb5274f67db781b3c6c0d068c325fb))
* complete Redux removal ([1c42dc3](https://github.com/riccardo-forina/insights-rbac-ui/commit/1c42dc37f60eb4e0422d745f444a0536f3c894bd))
* **components:** add TableView component with type-safe API ([4fab761](https://github.com/riccardo-forina/insights-rbac-ui/commit/4fab7613c27923cf93798bd39d58489df4264912))
* comprehensive codebase modernization and tooling overhaul ([3d01173](https://github.com/riccardo-forina/insights-rbac-ui/commit/3d011734ada451fe0912b9e7ec396b97cacb60de))
* convert roles and users JS components to TypeScript with TableView migration ([c3f86a7](https://github.com/riccardo-forina/insights-rbac-ui/commit/c3f86a75e1cc7299f3ee7040a8b934afcb658a38))
* convert Storybook e2e user journeys to PlayWright ([7300be1](https://github.com/riccardo-forina/insights-rbac-ui/commit/7300be18804354e9cd8bcd3171b4361f316d409f))
* create add to user group modal ([0112379](https://github.com/riccardo-forina/insights-rbac-ui/commit/011237902147bd8f7c6e702bb58524016d353269))
* create Audit Log page ([#2150](https://github.com/riccardo-forina/insights-rbac-ui/issues/2150)) ([d4eaf18](https://github.com/riccardo-forina/insights-rbac-ui/commit/d4eaf189bc27f0deaee8c2e743c4a47f77c169dd))
* create delete user groups modal ([#1703](https://github.com/riccardo-forina/insights-rbac-ui/issues/1703)) ([ed28740](https://github.com/riccardo-forina/insights-rbac-ui/commit/ed2874000ab2e090d0244865ccafe58aed2a5252))
* create edit user group page ([#1732](https://github.com/riccardo-forina/insights-rbac-ui/issues/1732)) ([6ee38d3](https://github.com/riccardo-forina/insights-rbac-ui/commit/6ee38d35da0edbc97ab34126de3349db2421e7fc))
* create role access modal ([d89a6c4](https://github.com/riccardo-forina/insights-rbac-ui/commit/d89a6c4c1447ff032edf1821eaa37f177576e562))
* create user details view ([53ccf7a](https://github.com/riccardo-forina/insights-rbac-ui/commit/53ccf7a6970e48ff7881a910c69370950a433899))
* create user group page ([#1770](https://github.com/riccardo-forina/insights-rbac-ui/issues/1770)) ([55f911e](https://github.com/riccardo-forina/insights-rbac-ui/commit/55f911e3870176d663594b432d66a0dbe84ef2e7))
* decouple V2 permission checks from V1 access API ([65f43f1](https://github.com/riccardo-forina/insights-rbac-ui/commit/65f43f102289aabcb27d5ac1736d8a9fc7c14568)), closes [RedHatInsights/insights-chrome#3418](https://github.com/RedHatInsights/insights-chrome/issues/3418)
* delete workspace disable when non empty ([2fdb4fe](https://github.com/riccardo-forina/insights-rbac-ui/commit/2fdb4fe54ddab5b99ccc62ac0dfb903efa34c748))
* **dev-proxy:** use dev proxy when running start ([#1923](https://github.com/riccardo-forina/insights-rbac-ui/issues/1923)) ([19fedeb](https://github.com/riccardo-forina/insights-rbac-ui/commit/19fedeb8954a0d674f6636ded7ed6c7ce211234d))
* **e2e:** add CI setup for Konflux ([ca2959e](https://github.com/riccardo-forina/insights-rbac-ui/commit/ca2959e629adfd3ef8187125a4fd265c0a8d3852))
* **e2e:** add infrastructure for 8 test personas ([abe6d59](https://github.com/riccardo-forina/insights-rbac-ui/commit/abe6d59712f9370bf081386d2594ed21b9065814))
* **e2e:** enhance Playwright test suite with page objects, pagination, and reliability fixes ([ae2d270](https://github.com/riccardo-forina/insights-rbac-ui/commit/ae2d270225914bae3bc90797c171ea22a00ba0f4))
* **e2e:** improve test patterns and seeder admin user support ([56d0d4e](https://github.com/riccardo-forina/insights-rbac-ui/commit/56d0d4ebbe4c48b650f8dab056191a553ed8c969))
* **e2e:** unified V1+V2 test architecture with separate seed maps ([0b7c6b9](https://github.com/riccardo-forina/insights-rbac-ui/commit/0b7c6b997a080133fec5ea10b377aa754a26ea80))
* **EditWorkspace:** add edit workspace modal ([#1783](https://github.com/riccardo-forina/insights-rbac-ui/issues/1783)) ([f7a46e4](https://github.com/riccardo-forina/insights-rbac-ui/commit/f7a46e4c4b1b0ef2d84c44caf247ada8af947009))
* **editworkspace:** add the edit workspace wizard to list view ([#1799](https://github.com/riccardo-forina/insights-rbac-ui/issues/1799)) ([d314f48](https://github.com/riccardo-forina/insights-rbac-ui/commit/d314f4828144bbc4eaad4973f4c69f2e407143e9))
* enable sorting and filtering for users table ([#1777](https://github.com/riccardo-forina/insights-rbac-ui/issues/1777)) ([70507bb](https://github.com/riccardo-forina/insights-rbac-ui/commit/70507bb8c57e4126ab361b6da8dd659649bf90ea))
* enforce granular permissions for read-only users ([4979934](https://github.com/riccardo-forina/insights-rbac-ui/commit/49799344cc2af0224b21fc11094fdfcbf5edc26e))
* enrich workspaces with Kessel permissions and add permission-based selector filtering ([a80eb86](https://github.com/riccardo-forina/insights-rbac-ui/commit/a80eb86f02ddc711757f02b5a861a7aaa27f5c82))
* **GrantAccessWizard:** add roles selection step ([3f97b0f](https://github.com/riccardo-forina/insights-rbac-ui/commit/3f97b0f9a6393e12cd85326bc6b7b11fc9cad127))
* **grantaccesswizard:** add user groups selector ([#1992](https://github.com/riccardo-forina/insights-rbac-ui/issues/1992)) ([4fa514d](https://github.com/riccardo-forina/insights-rbac-ui/commit/4fa514d31ca9b90b90b3f68de68ea42301103db5))
* **grantaccesswizard:** create grant access wizard ([37f7d19](https://github.com/riccardo-forina/insights-rbac-ui/commit/37f7d19d1fd8c380ced10cfb2b6b3ad1c31ceba9))
* **GroupRoles:** migrate to TableView ([6df9fd7](https://github.com/riccardo-forina/insights-rbac-ui/commit/6df9fd7c033578b2fb56e753e6dcb17be7a549a0))
* **groups:** add confirmation modals for remove actions on roles and members ([#1994](https://github.com/riccardo-forina/insights-rbac-ui/issues/1994)) ([1b94e8a](https://github.com/riccardo-forina/insights-rbac-ui/commit/1b94e8a84549f155d10049bb550766d888b394bb))
* **GroupServiceAccounts:** migrate to TableView ([adced0c](https://github.com/riccardo-forina/insights-rbac-ui/commit/adced0c5b9fb72b45989e10d7bf3e3af98aa3152))
* **groups:** migrate Groups slice from Redux to React Query ([82c8537](https://github.com/riccardo-forina/insights-rbac-ui/commit/82c853725c8cedc6f2e087c6f937916c84c40e75))
* **Groups:** use TableView to simplify the code ([e9e3df7](https://github.com/riccardo-forina/insights-rbac-ui/commit/e9e3df74aa32b0641ff6b6bf502313600223ded6))
* implement comprehensive Storybook integration and component documentation ([1095985](https://github.com/riccardo-forina/insights-rbac-ui/commit/1095985f79154756ff312c004feb5d7c82e75e25))
* **invite-users:** add invite users modal via data driven forms ([#1706](https://github.com/riccardo-forina/insights-rbac-ui/issues/1706)) ([98cb047](https://github.com/riccardo-forina/insights-rbac-ui/commit/98cb047b14ff13885d7ce2ea3f92cdccd5a7df49))
* **konflux:** enablet unit tests on Konflux ([#1656](https://github.com/riccardo-forina/insights-rbac-ui/issues/1656)) ([527b4d8](https://github.com/riccardo-forina/insights-rbac-ui/commit/527b4d89273077820459004049fbd16b79e42d2b))
* **konflux:** introduce remote Konflux pipeline ([#1793](https://github.com/riccardo-forina/insights-rbac-ui/issues/1793)) ([b75e11b](https://github.com/riccardo-forina/insights-rbac-ui/commit/b75e11b20f51685b2f1c01514c90b8be8a5ac8ae))
* **lint:** enforce story play function patterns via ESLint ([23e013e](https://github.com/riccardo-forina/insights-rbac-ui/commit/23e013ef53ca644e2ce4639cdb5d27e698e9e7b7))
* migrate DataView components to TableView with useTableState ([a1f33d5](https://github.com/riccardo-forina/insights-rbac-ui/commit/a1f33d586964018e0cb430d9c3d5b04274630172))
* migrate role bindings API to exclude_sources, rename UI hooks ([aed3fbc](https://github.com/riccardo-forina/insights-rbac-ui/commit/aed3fbc28da8f61712a93591052dbc0db851dd63))
* migrate Roles slice from Redux to TanStack Query ([23f668d](https://github.com/riccardo-forina/insights-rbac-ui/commit/23f668df8970f870ef79a9a8f5ea5fd39ee3ddd7))
* migrate workspace permissions to Kessel access checks ([1fd7495](https://github.com/riccardo-forina/insights-rbac-ui/commit/1fd7495501a0f40c65d2d63c9f4c4008f08341e4))
* migrate WorkspaceSelector to React Query and reorganize federated modules ([aef5e25](https://github.com/riccardo-forina/insights-rbac-ui/commit/aef5e25fb0e2e0f9980f526ec3d4a7d9e51a1556))
* **myuseraccess:** filter out out-of-scope bundles and apps for itless env ([#1867](https://github.com/riccardo-forina/insights-rbac-ui/issues/1867)) ([6d42875](https://github.com/riccardo-forina/insights-rbac-ui/commit/6d4287552d8c27c32e35a1e85232ff5a4b8f8981))
* **nav:** iam nav overhaul ([#1993](https://github.com/riccardo-forina/insights-rbac-ui/issues/1993)) ([4771166](https://github.com/riccardo-forina/insights-rbac-ui/commit/4771166cf61893e12df87340ad37944148e31bd2))
* **navigation:** e2e navigation structure ([#2171](https://github.com/riccardo-forina/insights-rbac-ui/issues/2171)) ([3b87253](https://github.com/riccardo-forina/insights-rbac-ui/commit/3b872534c1fcc4def51e0b895a71e2fe8c317383))
* prevent workspace movement to child nodes ([594fafa](https://github.com/riccardo-forina/insights-rbac-ui/commit/594fafa1af77948645614eafcc8b910c656211bc))
* programmatically enable redux devtools extension support ([b490e60](https://github.com/riccardo-forina/insights-rbac-ui/commit/b490e60214252da9cbc0e1aff7f33543d89096d1))
* **rbac:** add access-requests ([#754](https://github.com/riccardo-forina/insights-rbac-ui/issues/754)) ([7fa22b0](https://github.com/riccardo-forina/insights-rbac-ui/commit/7fa22b0bd7ee61f09e266e09ac2691b1f011fd2f))
* remove Redux from type definitions and error handling ([9ad29a3](https://github.com/riccardo-forina/insights-rbac-ui/commit/9ad29a3c0e1342f8632606968b2291773aa691aa))
* replace custom SVG icons with PatternFly icons in WorkspacesOverview ([#1913](https://github.com/riccardo-forina/insights-rbac-ui/issues/1913)) ([f50bbbb](https://github.com/riccardo-forina/insights-rbac-ui/commit/f50bbbb36321fcae5ed3dc460c78f7d53975f533))
* replace stateful-handlers with @msw/data mock databases, implement M4 features ([97392cc](https://github.com/riccardo-forina/insights-rbac-ui/commit/97392cc823a326ccbc9d6d8aa01abb1ea35d9e61))
* **role wizard:** include add role wizard to new role page ([18b0aab](https://github.com/riccardo-forina/insights-rbac-ui/commit/18b0aabc54effb0e6f158bb18e38ee50814f8e8b))
* **role-binding:** use new version of rbac client to support role binding ([aecbce9](https://github.com/riccardo-forina/insights-rbac-ui/commit/aecbce9c1c2dab4826d63b850aac62f7696f53b8))
* **rolebinding:** connect Workspace tables to rolebinding api ([f9c7e04](https://github.com/riccardo-forina/insights-rbac-ui/commit/f9c7e04e16cbe13acafca94704653b28b05de924))
* **Rolebindings:** add Role binding api ([#1914](https://github.com/riccardo-forina/insights-rbac-ui/issues/1914)) ([9d0d0b3](https://github.com/riccardo-forina/insights-rbac-ui/commit/9d0d0b31cd064bed1237e2046c603b4fd9381ff0))
* **role:** edit role feature ([f581690](https://github.com/riccardo-forina/insights-rbac-ui/commit/f581690bf451e22abf8f2e19f21bdb0180b95e7f)), closes [#1795](https://github.com/riccardo-forina/insights-rbac-ui/issues/1795) [#1812](https://github.com/riccardo-forina/insights-rbac-ui/issues/1812)
* **roles,users:** migrate Role.tsx and User.tsx from Redux to React Query ([c45e532](https://github.com/riccardo-forina/insights-rbac-ui/commit/c45e532109e00f66630d477dee02921017b9ff94))
* **rolesdrawer:** make roles clickable ([c60f075](https://github.com/riccardo-forina/insights-rbac-ui/commit/c60f0757fe57a9f8fbe90fe65fc76210662b630f))
* **roles:** migrate roles list to TypeScript and fix race condition ([a0bd3e1](https://github.com/riccardo-forina/insights-rbac-ui/commit/a0bd3e1c81958f0e1eb5aeb8b0f3b62cdd67cf28))
* **RolesTable:** add bulk Delete Roles button ([7985c1e](https://github.com/riccardo-forina/insights-rbac-ui/commit/7985c1ed304bc793218635294527ed5a2cf11f4a))
* **RolesTable:** add sorting and filtering ([0558e6e](https://github.com/riccardo-forina/insights-rbac-ui/commit/0558e6ef4908da00ff6bc0a3a8f07305003327cf))
* **rolestable:** delete roles modal ([#1696](https://github.com/riccardo-forina/insights-rbac-ui/issues/1696)) ([546a465](https://github.com/riccardo-forina/insights-rbac-ui/commit/546a465963ea395fdb9c776313687b464d92b816))
* run test-storybook against Chromatic's build ([f0838dc](https://github.com/riccardo-forina/insights-rbac-ui/commit/f0838dc4f22f2a59d82240d228952d0523c8e0d0))
* **search:** add org admin global search entry ([17d4811](https://github.com/riccardo-forina/insights-rbac-ui/commit/17d48111fa3fc49024208fa9dcda3d97318e91b2))
* **serviceaccountslist:** convert service-accounts-list to use DataViewTable ([db75a8d](https://github.com/riccardo-forina/insights-rbac-ui/commit/db75a8d808a24d84d4af8bb9d08e781dec11bcb8))
* show WS enable alert only if user can perform this action ([#1681](https://github.com/riccardo-forina/insights-rbac-ui/issues/1681)) ([b89b2d3](https://github.com/riccardo-forina/insights-rbac-ui/commit/b89b2d3467f34996a36e5bd1052688fa4f021648))
* **storybook:** add comprehensive tests for remaining JS container components ([6530aed](https://github.com/riccardo-forina/insights-rbac-ui/commit/6530aedf81ff11e5a3c4be0bb009dcb2df27ee8e))
* **storybook:** add feature gap tests for V2 Users/UserGroups and Roles ([18da917](https://github.com/riccardo-forina/insights-rbac-ui/commit/18da91744ea2b3c8fa34b6d37e7ef0f72d0415f3))
* **Storybook:** detect problematic console messages and flag them as test errors ([a79dcbb](https://github.com/riccardo-forina/insights-rbac-ui/commit/a79dcbb5d1a00d7fe1e5766a9684394af5d30331))
* **Storybook:** mocked E2E test ([f107580](https://github.com/riccardo-forina/insights-rbac-ui/commit/f107580e36901b3595c64f4041ab5dc6cf7f876e))
* **Storybook:** mocked E2E test for Kessel milestones ([bafc655](https://github.com/riccardo-forina/insights-rbac-ui/commit/bafc65554a4c18e0db40fae1318b20345a54829f))
* support cursor-based pagination for V2 APIs ([c8d4229](https://github.com/riccardo-forina/insights-rbac-ui/commit/c8d42298c80ce1bd2771d719625cbd38672313cf))
* temporarily updated tooltip content for workspace naming guidelines ([#1880](https://github.com/riccardo-forina/insights-rbac-ui/issues/1880)) ([74c48d7](https://github.com/riccardo-forina/insights-rbac-ui/commit/74c48d7d536df2ba2d75dbdd708f2c37c38a34a1))
* update frontend components and use user data for org-mangement ([4ee9916](https://github.com/riccardo-forina/insights-rbac-ui/commit/4ee991663a7537d718bcb698f22b91981ea5ad55))
* update technology icon path ([#1912](https://github.com/riccardo-forina/insights-rbac-ui/issues/1912)) ([b9d14e2](https://github.com/riccardo-forina/insights-rbac-ui/commit/b9d14e24c9d9f76690ad0a621ab9aadd07066ce6))
* use new workspace selector in create workspace wizard ([#1862](https://github.com/riccardo-forina/insights-rbac-ui/issues/1862)) ([c3eeb71](https://github.com/riccardo-forina/insights-rbac-ui/commit/c3eeb7197189a51ff57a3bf970c8e01f36df9cf1))
* use useRoleBindingsQuery in org-management table ([c8203a0](https://github.com/riccardo-forina/insights-rbac-ui/commit/c8203a06d67abd2928b78a3c530ec7c99589a3c9))
* **usergroups:** add create usergroup button ([#1972](https://github.com/riccardo-forina/insights-rbac-ui/issues/1972)) ([0d6658b](https://github.com/riccardo-forina/insights-rbac-ui/commit/0d6658b12c37902eada9af4a923c3b8e187fde45))
* **UserGroupsTable:** migrate to TableView ([29a38b9](https://github.com/riccardo-forina/insights-rbac-ui/commit/29a38b909cdcba757aab954b90396c7e262be62d))
* **userstable:** add delete user modal ([814f7f1](https://github.com/riccardo-forina/insights-rbac-ui/commit/814f7f161c513f7fe3bfd95c4909f30e10c18f30))
* **UsersTable:** migrate to TableView ([1aa3cb0](https://github.com/riccardo-forina/insights-rbac-ui/commit/1aa3cb063dfd31f5a839eeab45c02dfb70940983))
* **users:** Unify users table ([#1900](https://github.com/riccardo-forina/insights-rbac-ui/issues/1900)) ([4e15933](https://github.com/riccardo-forina/insights-rbac-ui/commit/4e15933dba2b9ebe5870b3339bd817336351d0ec))
* **workspaceDetails:** should be hidden when platform.rbac.workspaces-list flag is on ([#1784](https://github.com/riccardo-forina/insights-rbac-ui/issues/1784)) ([5a68258](https://github.com/riccardo-forina/insights-rbac-ui/commit/5a68258a666d5f206c29f8bcbd705bd7a6b707a2))
* **workspaces:** add ability to delete workspace from list view ([d0256af](https://github.com/riccardo-forina/insights-rbac-ui/commit/d0256af541c9a067c29e5819c7ab66299706828c))
* **Workspaces:** add ability to delete workspaces on details page ([c969f0f](https://github.com/riccardo-forina/insights-rbac-ui/commit/c969f0f4086a26820af2e753fdfc55c6fcb595fc))
* **workspaces:** allow ungrouped ws to have inventory detail ([#1839](https://github.com/riccardo-forina/insights-rbac-ui/issues/1839)) ([d631ac0](https://github.com/riccardo-forina/insights-rbac-ui/commit/d631ac0b79c305429738b4e2f26ed13d718e5cec))
* **workspaces:** enable overview if feature flag enabled ([#1683](https://github.com/riccardo-forina/insights-rbac-ui/issues/1683)) ([59fa607](https://github.com/riccardo-forina/insights-rbac-ui/commit/59fa60744a0fe99304f4cda2795c0a2120036c49))
* **workspaces:** migrate Workspaces feature from Redux to React Query ([80543f7](https://github.com/riccardo-forina/insights-rbac-ui/commit/80543f7df9b86278d56447031baaeaf63c26b0f2))
* **workspaces:** redirect to inventory ws table ([#1836](https://github.com/riccardo-forina/insights-rbac-ui/issues/1836)) ([ce0d204](https://github.com/riccardo-forina/insights-rbac-ui/commit/ce0d204b5b20cfb87bba0e7e525b5d59de80917b))
* **workspacewizard:** disable ws parent select ([#1832](https://github.com/riccardo-forina/insights-rbac-ui/issues/1832)) ([a237733](https://github.com/riccardo-forina/insights-rbac-ui/commit/a23773346e8a6cd090512b56de0885e69d0f5fcf))
* **workspacewizard:** expose workspace wizard through fec ([#1794](https://github.com/riccardo-forina/insights-rbac-ui/issues/1794)) ([b61d172](https://github.com/riccardo-forina/insights-rbac-ui/commit/b61d1724fca00eae2af91bcc26728f3bd8c389fb))
* **ws-selector:** add documentation and expose managed selector ([d41569d](https://github.com/riccardo-forina/insights-rbac-ui/commit/d41569db2e63c3c671a7b094253950cdbd8ca5f0))
* **WS:** add loading and empty state to workspace list table ([#1751](https://github.com/riccardo-forina/insights-rbac-ui/issues/1751)) ([b2e8f1d](https://github.com/riccardo-forina/insights-rbac-ui/commit/b2e8f1d7eade80b826dbf202b085e78c96a483fc))


### Performance Improvements

* decouple permission loading from workspace data rendering ([71564a3](https://github.com/riccardo-forina/insights-rbac-ui/commit/71564a38e33a7855e0b6717a5c2b2a39d57954df))


### Reverts

* Revert "chore(deps): bump http-proxy-middleware from 2.0.6 to 2.0.9 ([#1814](https://github.com/riccardo-forina/insights-rbac-ui/issues/1814))" ([#1831](https://github.com/riccardo-forina/insights-rbac-ui/issues/1831)) ([daabcc3](https://github.com/riccardo-forina/insights-rbac-ui/commit/daabcc32b0a2db120703b7c8ea76e21e91941cde))
* Revert "Do not send username when creating service account ([#1559](https://github.com/riccardo-forina/insights-rbac-ui/issues/1559))" ([#1560](https://github.com/riccardo-forina/insights-rbac-ui/issues/1560)) ([a310c88](https://github.com/riccardo-forina/insights-rbac-ui/commit/a310c885ab44d063e378393b75f161aa04670704))
* Revert "feat: add empty new edit role page ([#1795](https://github.com/riccardo-forina/insights-rbac-ui/issues/1795))" ([#1812](https://github.com/riccardo-forina/insights-rbac-ui/issues/1812)) ([e86b412](https://github.com/riccardo-forina/insights-rbac-ui/commit/e86b412deca0c34c99e447e71de8fd255c41e23d))
* Revert "feat(groups): add confirmation modals for remove actions on roles and…" ([#1995](https://github.com/riccardo-forina/insights-rbac-ui/issues/1995)) ([33a6daf](https://github.com/riccardo-forina/insights-rbac-ui/commit/33a6daf9bcbe9f11b6fd02fbb09fb5f860020006))
* Revert "Revert "Do not send username when creating service account ([#1559](https://github.com/riccardo-forina/insights-rbac-ui/issues/1559))" ([#1560](https://github.com/riccardo-forina/insights-rbac-ui/issues/1560))" ([#1561](https://github.com/riccardo-forina/insights-rbac-ui/issues/1561)) ([38dc92f](https://github.com/riccardo-forina/insights-rbac-ui/commit/38dc92fea5c5cd4db8a3dd1cbfe90cce572656a1))
