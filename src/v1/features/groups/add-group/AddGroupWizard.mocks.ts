...
import type { RoleOutDynamic } from '../../../data/api/roles';

export const mockRoles: RoleOutDynamic[] = [
  {
    uuid: 'role-1',
...
export const mockServiceAccountsForHandlers: MockServiceAccount[] = mockServiceAccounts.map((sa) => ({
  uuid: sa.id,
  name: sa.name,
  clientId: sa.clientId,
  owner: sa.createdBy,
  timeCreated: new Date(sa.createdAt * 1000).toISOString(),
