...
// React Query
import { useAdminGroupQuery, useGroupsQuery } from '../../../shared/data/queries/groups';
...
export const Groups: React.FC = () => {
  ...
  const handleEdit = useCallback(
    (groupId: string) => {
      navigate(pathnames['edit-group'].link(groupId));
    },
    [navigate],
  );
  ...
  const handleDelete = useCallback(
    (groupsToDelete: Group[]) => {
      ...
      navigate(pathnames['remove-group'].link(groupIds.join(',')));
