...
import InventoryGroupsRole from '../../../features/roles/add-role/InventoryGroupsRole';
...
describe('Inventory groups role', () => {
  ...
  test('Selecting group for permission and Copy to all to other permissions successfully', async () => {
    ...
    const badgesAfterSelection = screen.getAllByText('1', { selector: '.pf-v6-c-badge' });
    ...
    const badgesAfterCopyAll = screen.getAllByText('1', { selector: '.pf-v6-c-badge' });
  ...
  test('Cancelling groups selection clears selections successfully', async () => {
    ...
    const badgesBeforeClear = screen.getAllByText('1', { selector: '.pf-v6-c-badge' });
