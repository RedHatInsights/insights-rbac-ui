...
import { DEFAULT_GROUPS } from '../../data/mocks/seed';
...
export const NormalOperation: Story = {
  parameters: {
    msw: {
      handlers: groupsHandlers(DEFAULT_GROUPS.slice(0, 2), { networkDelay: 100 }),
    },
  },
  render: () => (
    <StoryWrapper>
...
export const Error502BadGateway: Story = {
  parameters: {
    msw: {
      handlers: groupsErrorHandlers(502),
    },
  },
  render: () => (
    <StoryWrapper>
...
their context.
    ...
    msw: {
      handlers: groupsErrorHandlers(404),
    },
  },
  render: () => (
    <StoryWrapper>
