...
`,
    ...
    msw: {
      handlers: [...roleBindingsBySubjectResponseHandlers(mockRoleBindingsResponse)],
    },
  },
  decorators: [
    (Story) => (
...
const withRoleBindings = (response: typeof mockRoleBindingsResponse) => ({
  msw: { handlers: [...roleBindingsBySubjectResponseHandlers(response)] },
});
...
export const EmptyRoleBindingsState: Story = {
  ...
  parameters: {
    ...
    msw: {
      handlers: [
        ...roleBindingsBySubjectResponseHandlers({
          data: [],
          meta: { limit: 20 },
