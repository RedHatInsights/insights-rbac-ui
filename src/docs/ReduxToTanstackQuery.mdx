...
<Meta title="Documentation/Architecture/Redux to TanStack Query" />
...
- [Query Keys Factory Pattern](?path=/docs/documentation-patterns-query-keys-factory--docs)
- [Type-Safe Form Submission Pattern](?path=/docs/documentation-patterns-type-safe-form-submission--docs)
...
See [Query Keys Factory Pattern](?path=/docs/documentation-patterns-query-keys-factory--docs) for details.
...
- `OrgAdminToggle.tsx` - Org admin toggle
...
- `useAddServiceAccountsToGroupMutation` - Add service accounts
- `useRemoveServiceAccountsFromGroupMutation` - Remove service accounts
...
See [Query Keys Factory Pattern](?path=/docs/documentation-patterns-query-keys-factory--docs) for full details.
...
See [Type-Safe Form Submission Pattern](?path=/docs/documentation-patterns-type-safe-form-submission--docs) for full details.
