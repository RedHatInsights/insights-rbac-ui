...
For comprehensive E2E testing documentation, see **[E2E Testing Strategy](/docs/documentation-e2e-testing-strategy--docs)** in this Storybook.

```typescript
// e2e/journeys/v1/roles/admin.spec.ts
import { test, expect } from '@playwright/test';
import { AUTH_V1_ADMIN, SEEDED_ROLE_NAME, getPrefixedName } from '../../../utils';
