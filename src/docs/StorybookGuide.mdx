...
- ❌ Don't let stories document complex wrapper components (like legacy `TableToolbarView`)
...
- ❌ Don't use legacy table components or similar complex wrappers in stories
