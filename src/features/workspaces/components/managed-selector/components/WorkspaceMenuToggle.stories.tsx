...
export const WithLongWorkspaceName: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByText('Development and Testing Environment with Very Long Name')).toBeInTheDocument();
  },
};
...
export const Loading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByText('Loading workspaces...')).toBeInTheDocument();
