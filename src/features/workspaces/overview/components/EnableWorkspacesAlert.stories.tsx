...
export const NotEligibleNotEnabled: StoryObj<FeatureFlagContextArgs> = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId('component-hidden-message')).toBeInTheDocument();
...
export const InteractiveDemo: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByText('Your workspace migration is complete and ready to manage!')).toBeInTheDocument();
  },
};
