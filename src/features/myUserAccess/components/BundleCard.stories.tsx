...
export const LightspeedRebrand: Story = {
  ...
  args: {
    header: 'My Applications - Lightspeed Rebrand',
    entitlements: sampleEntitlements,
    isDisabled: false,
    currentBundle: 'ansible',
  },
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Shows the Lightspeed rebrand feature flag in action. When enabled, "insights" in the Ansible Automation Platform card is displayed as "Lightspeed" instead. The Ansible card is selected to highlight the change.',
      },
    },
  },
};
