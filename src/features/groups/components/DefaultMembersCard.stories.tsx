...
export const PlatformDefault: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const message = canvas.getByRole('heading', { level: 1 });
    expect(message).toBeInTheDocument();
    expect(message).toHaveTextContent('All users in this organization are members of this group.');
  },
};
...
export const AdminDefault: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const message = canvas.getByRole('heading', { level: 1 });
    expect(message).toBeInTheDocument();
    expect(message).toHaveTextContent('All organization administrators in this organization are members of this group.');
  },
};
