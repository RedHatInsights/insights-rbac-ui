  ...
  const handleBulkSelect = useCallback(
    (value: BulkSelectValue) => {
      if (value === BulkSelectValue.none) {
        ...
        selection.onSelect(true, serviceAccounts);
      } else if (value === BulkSelectValue.nonePage) {
        selection.onSelect(false, serviceAccounts);
      }
    },
    [selection, serviceAccounts],
  );
          ...
          <>
            ...
            <DataView activeState={activeState} selection={hasPermissions ? selection : undefined}>
              <DataViewToolbar
                ...
                actions={toolbarButtons.filter((button) => React.isValidElement(button))}
                filters={
