...
import AddGroupMembers from './add-group-members-legacy';
...
// 🎯 WRAPPER COMPONENT: Provides button to open modal (following modal testing rules)
...
const meta: Meta<any> = {
  title: 'Features/Groups/Group/Member/AddGroupMembers-Legacy',
  component: AddGroupMembersWrapper,
  tags: ['add-group-members', 'modal-testing', 'filtering-pagination'],
  parameters: {
    layout: 'fullscreen',
    msw: {
      handlers: [
  ...
  decorators: [
    (Story) => (
      <MemoryRouter initialEntries={['/groups/detail/test-group-id/members/add-members']}>
        <Routes>
          <Route path="/groups/detail/:groupId/members/add-members" element={<Story />} />
        </Routes>
      </MemoryRouter>
    ),
  ],
