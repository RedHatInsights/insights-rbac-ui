...
export const AddMemberButton: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const toolbarKebab = await canvas.findByLabelText('Member bulk actions');
...
export const RowActions: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const rowKebab = within(aliceRow).getByLabelText(/actions for alice\.johnson/i);
...
Perfect for code review and UX validation.
  ...
  play: async ({ canvasElement }) => {
    ...
    const kebabButton = within(aliceRow).getByLabelText(/actions for alice\.johnson/i);
