...
const CombinedToolbar: React.FC<{
  ...
  <TopToolbar breadcrumbs={breadcrumbs}>
    <TopToolbarTitle title={title} description={description} renderTitleTag={renderTitleTag}>
      {children}
    </TopToolbarTitle>
  </TopToolbar>
);
...
const meta: Meta<typeof CombinedToolbar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
TopToolbar and TopToolbarTitle are layout components that provide consistent page headers throughout the RBAC application.

## Components

- **TopToolbar**: Main container that handles breadcrumbs and page header layout
- **TopToolbarTitle**: Title section with support for descriptions, tags, and additional content
...
/**
 * Individual TopToolbar component
 */
export const ToolbarOnly: StoryObj<typeof TopToolbar> = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'TopToolbar used independently with custom content.',
      },
    },
  },
};
...
/**
 * Individual TopToolbarTitle component
 */
export const TitleOnly: StoryObj<typeof TopToolbarTitle> = {
  render: () => (
    <div style={{ padding: '20px' }}>
      <TopToolbarTitle
        title="Standalone Title"
        description="This title component can be used outside of TopToolbar."
  ...
  parameters: {
    docs: {
      description: {
        story: 'TopToolbarTitle used independently for custom layouts.',
      },
    },
  },
};
