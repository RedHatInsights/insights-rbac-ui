...
export const CreateNew: Story = {
  args: {
    ...
    actions: (
      <Button variant="primary" icon={<PlusCircleIcon />} onClick={() => console.log('Create group clicked')}>
        Create group
      </Button>
    ),
  },
...
export const Warning: Story = {
  args: {
    ...
    actions: (
      <Button variant="secondary" onClick={() => console.log('Contact admin clicked')}>
...
export const Unauthorized: Story = {
  args: {
    ...
    actions: (
      <Button variant="primary" onClick={() => console.log('Sign in clicked')}>
        Sign in
      </Button>
    ),
  },
...
export const MultipleActions: Story = {
  args: {
    ...
    actions: (
      <div>
        <Button variant="primary" style={{ marginRight: '8px' }} onClick={() => console.log('Invite users clicked')}>
          Invite users
        </Button>
        <Button variant="link" onClick={() => console.log('Import users clicked')}>
          Import users
        </Button>
      </div>
    ),
...
export const SimpleDescription: Story = {
  args: {
    ...
    actions: (
      <Button variant="link" onClick={() => console.log('Refresh clicked')}>
        Refresh
      </Button>
    ),
  },
...
export const CustomIcon: Story = {
  args: {
    ...
    actions: (
      <Button variant="link" onClick={() => console.log('Retry clicked')}>
        Try again
      </Button>
    ),
  },
