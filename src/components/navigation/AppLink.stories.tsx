...
It merges the provided 'to' prop with the /iam basename to ensure proper navigation within the Red Hat Console environment.

## Features
- Automatically resolves app basename to /iam
