...
const GroupRoles = lazy(() => import('./features/groups/group/role/group-roles'));
const GroupServiceAccounts = lazy(() => import('./features/groups/group/service-account/group-service-accounts'));
const AddGroupRoles = lazy(() => import('./features/groups/group/role/add-group-roles'));
const AddGroupMembers = lazy(() => import('./features/groups/group/member/add-group-members'));
