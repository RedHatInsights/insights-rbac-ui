...
const UsersAndUserGroups = lazy(() => import('./features/access-management/users-and-user-groups/users-and-user-groups'));
const UsersView = lazy(() => import('./features/access-management/users-and-user-groups/users/UsersView'));
const UserGroupsView = lazy(() => import('./features/access-management/users-and-user-groups/user-groups/UserGroupsView'));
