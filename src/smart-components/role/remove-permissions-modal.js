  ...
  return (
    ...
    >
      <Grid gutter="sm">
        <GridItem span={5}>
          <TextContent>
            <Text component={TextVariants.h1}>Removing Permission:</Text>
          </TextContent>
        </GridItem>
        <GridItem span={6}>
...
RemovePermissionsModal.defaultProps = {
  role: {},
  isLoading: true,
};
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RemovePermissionsModal));
