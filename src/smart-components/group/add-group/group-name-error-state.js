...
import { Title, Button, EmptyState,
  EmptyStateVariant,
  EmptyStateIcon,
...
const GroupNameErrorState = ({ setHideFooter }) => {
  ...
  return (
    <EmptyState variant={ EmptyStateVariant.small }>
      ...
      <EmptyStateBody>
        Please return to Step 1: Group information and choose a&nbsp;unique name for your group.
      </EmptyStateBody>
      <Button variant="primary" onClick={ () => document.getElementsByClassName('pf-c-wizard__nav-link')[0].click() }>Return to Step 1</Button>
    </EmptyState>
  );
};
